package com.example.voiceassistant.activities.text;
...
import com.example.voiceassistant.databinding.ActivityGetTextFromVoiceBinding;
import com.example.voiceassistant.databinding.ActivityTextEngToRuBinding;

import java.util.ArrayList;

public class TextEngToRu extends AppCompatActivity {

    private ActivityTextEngToRuBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGetTextFromVoiceBinding.inflate(getLayoutInflater());
